...
from PPD import PPD
from My_wrapper import RenderFrameWrapper, AddStateObsWrapper
from StudentTeacher_distillation import Student_Distillation, Teacher_Distillation
...
def Train_student_distillation():
    ...
    folder_path = "./Results/LunarLander/StudentDistillation/"
    dict_enviroment = {
        "run_name": f"StudentDistillation_LunarLander",
        "env_name": default_config["env_name"],
        "render_idx": list(range(0, default_config["num_envs"])),
        "record_video_idx": [],
        "folder_path" : folder_path,
    ...
    dict_test_enviroment = {
        ...
        "render_idx": list(range(0, default_config["num_envs"])),
        "record_video_idx": [0],
        "IDseeds": list(range(100, 110)),
        "ODseeds": list(range(200, 210)),
        "folder_path" : folder_path
    }
    Distillation_trainer = Student_Distillation(
        student=Student,
        teacher=Teacher,
        path_folder=dict_enviroment["folder_path"],
        dict_enviroment=dict_enviroment,
