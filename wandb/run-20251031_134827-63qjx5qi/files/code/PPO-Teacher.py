...
from Utils_PPO import PPO_Agent, PPO_Image_model, make_env, set_seeds
from dataclasses import dataclass
...
class Args:
    ...
    # Cambia questa riga
    enviroment: Literal["LunarLander", "CarRacing"] = "LunarLander"
...
def train():
    ...
    for iteration in range(1, args.num_iterations + 1):
        ...
        writer.add_scalar("chart/Average_reward", Running_Average, global_step)

        if Running_Average > args.target_reward:
        ...
        writer.add_scalar("losses/Entropy_coef", curr_ent_coef, global_step)
        ...
        print(f'SPS: {int(global_step / (time.time() - start_time))}, Avg rew: {Running_Average:.2f}, it: {iteration}/{args.num_iterations}, n times average reward >= 250: {n_times_better_target_value}/100')
